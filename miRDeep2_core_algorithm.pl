...
sub pass_filtering_structure{
    ...
    unless(ttl_unpaired()<6){$ret=0; $hash_comp{"problem_duplex_lng"}="too many unpaired bases in duplex\n";}

    unless(consc_unpaired()<=3){$ret=0; $hash_comp{"problem_duplex_lng"}="too long size of consecutive unpaired bases in duplex\n";}
