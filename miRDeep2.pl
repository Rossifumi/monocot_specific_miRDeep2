...
sub parse_mappings{
	...
	print STDERR "parse_mappings.pl $file_reads_vs_genome -a 0 -b 15 -c 32 -i 20 > $dir_tmp/${parsed_arf}_parsed.arf\n\n";
    start();


    my $ret_parse_mappings=`parse_mappings.pl $file_reads_vs_genome -a 0 -b 15 -c 32 -i 20 > $dir_tmp/${parsed_arf}_parsed.arf`;
    end();
