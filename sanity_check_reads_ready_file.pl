...
$_\n
contains less than 15 characters or contains characters others than [acgtunACGTUN]\n
Please make sure that your file only comprises sequences that have at least 15 characters\n
...
";
        ...
        }elsif(/^([A|C|G|T|U|N|a|c|g|t|u|n]{15,})$/){
            if($hash_seq{$tag}{$1}){
                die "Error in line ",Nicenumber($counter),": The sequence\n
$1\n
occures at least twice in sample $tag in your reads file.\n
